    ...
    return (
        <div className='flex flex-col gap-10 px-3 py-10 md:px-10 lg:px-16 xl:px-32'>
            <div className='w-full bg-gradient-to-r from-[#e8dfc9] to-[#f9f9f9] py-5 shadow-xl rounded-md'>
                <h1 className='text-[#3B3B3B]  text-xl font-medium text-center'>Edit Add</h1>
            </div>
            ...
            <div className='flex flex-col justify-center w-full gap-3'>
                <h1 className='text-[#3B3B3B]  text-lg font-medium'>Edit Description</h1>
            ...
            <div className='flex justify-between'>
                ...
                <div className='w-44'>
                    <Button variant='filled' color='#D5BD81' fullWidth>Edit</Button>
                </div>
            </div>
